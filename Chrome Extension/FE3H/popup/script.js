...
document.getElementById("class-names").addEventListener("change", showClass)
document.getElementById("plus").addEventListener("click", work)
document.getElementById("da-button").addEventListener("click", runAlgorithm)